...
public class ShowStock extends JPanel{
    private String[] columnNames = {"No", "Blood Type", "Quantity"};
    private Object[][] data = {
            {"", "", "", "", "", ""}
    };
    ...
    public ShowStock(String data) {
        ...
        add_to_frequently = new JMenuItem("");
    ...
    public void getAllData() {
        ...
        table.revalidate();
        try {
            ArrayList<String[]> ds = Connector.getInstance().parseStockJSON(this.datas);
